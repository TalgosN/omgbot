...
Все остальные хештеги бот передаёт в общий маршрут `POST /api/bot/hashtag`.
Список правил, тип начисления и фиксированные суммы находятся в OMG Shift и
могут меняться без обновления бота. Встроенные правила включают `#др`,
`#двойная`, `#автосим` и `#активация`; актуальный список выводится в `/help`.
