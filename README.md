...
Исторические записи прежней системы сохранены в универсальных таблицах с
источником `legacy`. Они исключены из рабочих выборок, поэтому не создают
дубли в Mini App и рассылках.
