...
Рабочий источник настроек находится в таблице [Виарыч](https://docs.google.com/spreadsheets/d/1LxBCPpWXtpS_EVhGUNuH2k4HtPnsu53ZF-4QaRET08Q/edit). Для синхронизации используются шесть листов:

- `📘 Инструкция` с правилами редактирования;
- `🏷 Клубы` для Telegram-тегов и отображения в расписании;
- `🕒 Время работы` для времени открытия, закрытия и проверок;
- `❓ Вопросы смены` для вопросов и связанных с ними пунктов чек-листа;
- `🚦 Проверка` с результатом последней публикации;
