...
В нём можно открыть текущее промо, создать случайную игру недели или промо
по AppID, просматривать списки и архив, редактировать либо перегенерировать
тексты, согласовывать, откладывать и отменять промо. Также доступны состояние
dry-run очереди, переход к каталогу игр и изменение скидки по умолчанию.
