...
admin_funclist = ['📢 Рассылки', '📣 Промо', '📊 KPI сотрудников', '📦 Расходники (Админ)', '🧰 Дополнительно', '⬅️ Вернуться']
owner_admin_funclist = ['📢 Рассылки', '📣 Промо', '📊 KPI сотрудников', '📦 Расходники (Админ)', '🧰 Дополнительно', '👥 Управление ролями', '⬅️ Вернуться']
