...
owner_admin_funclist = ['📢 Рассылки', '📊 KPI сотрудников', '📝 Сценарии смен', '📦 Расходники (Админ)', '🧰 Дополнительно', '👥 Управление ролями', '⬅️ Вернуться']
admin_extra_funclist = ['⚙️ Обновить настройки', '🩺 Статус систем', '🧪 Диагностика KPI', '📦 Тест отчета по расходникам', '⬅️ Назад в админку']
owner_admin_extra_funclist = ['⚙️ Обновить настройки', '🔄 Сотрудники OMG Shift', '🩺 Статус систем', '🧪 Диагностика KPI', '📊 Тест недельного отчета', '📦 Тест отчета по расходникам', '⬅️ Назад в админку']
