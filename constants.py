...
admin_funclist = ['📢 Рассылки', '📊 KPI сотрудников', '📦 Расходники (Админ)', '🧰 Дополнительно', '⬅️ Вернуться']
owner_admin_funclist = ['📢 Рассылки', '📊 KPI сотрудников', '📦 Расходники (Админ)', '🧰 Дополнительно', '👥 Управление ролями', '⬅️ Вернуться']
admin_extra_funclist = ['⚙️ Обновить настройки', '🩺 Статус систем', '🧪 Диагностика KPI', '📦 Тест отчета по расходникам', '⬅️ Назад в админку']
owner_admin_extra_funclist = ['⚙️ Обновить настройки', '🩺 Статус систем', '🧪 Диагностика KPI', '📊 Тест недельного отчета', '📦 Тест отчета по расходникам', '⬅️ Назад в админку']

## Главное меню
OWNER_EMPLOYEE_MODE_BUTTON = "🧑🏻 Режим сотрудника"
OWNER_MODE_BUTTON = "👑 Вернуться в режим владельца"

funclist={0:("👨🏻‍💻 Смена", "🚩 Доска проблем","🗓 Расписание", "🎮 Steam Tracker", "👤 Аккаунт", '📦 Расходники', "🆘 Помощь"),
          1:("👨🏻‍💻 Смена", "🚩 Доска проблем","🗓 Расписание", "🎮 Steam Tracker", "👤 Аккаунт", '📦 Расходники', "🆘 Помощь"),
          2:("👨🏻‍💻 Смена", "🚩 Доска проблем","🗓 Расписание", "🎮 Steam Tracker", "👤 Аккаунт", "🧑🏻‍💻 Админ панель", '📦 Расходники', "🆘 Помощь"),
          3:("👨🏻‍💻 Смена", "🚩 Доска проблем","🗓 Расписание", "🎮 Steam Tracker", "👤 Аккаунт", "💲 Финансы", "🧑🏻‍💻 Админ панель", '📦 Расходники', "🆘 Помощь")} # с привилегиями
