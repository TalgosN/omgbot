...
admin_extra_funclist = ['⚙️ Обновить настройки', '🩺 Статус систем', '📦 Тест отчета по расходникам', '⬅️ Назад в админку']
owner_admin_extra_funclist = ['⚙️ Обновить настройки', '🔄 Сотрудники OMG Shift', '🩺 Статус систем', '📊 Тест недельного отчета', '📦 Тест отчета по расходникам', '⬅️ Назад в админку']
