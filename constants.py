...
admin_funclist = ['📢 Рассылки', '📊 KPI сотрудников', '📝 Сценарии смен', '🧰 Дополнительно', '⬅️ Вернуться']
owner_admin_funclist = ['📢 Рассылки', '📊 KPI сотрудников', '📝 Сценарии смен', '🧰 Дополнительно', '👥 Управление ролями', '⬅️ Вернуться']
admin_extra_funclist = ['⚙️ Обновить настройки', '🩺 Статус систем', '🎂 Тест поздравления', '📦 Тест отчета по расходникам', '⬅️ Назад в админку']
owner_admin_extra_funclist = ['⚙️ Обновить настройки', '🔄 Сотрудники OMG Shift', '🩺 Статус систем', '🎂 Тест поздравления', '📊 Тест недельного отчета', '📦 Тест отчета по расходникам', '⬅️ Назад в админку']

## Главное меню
OWNER_EMPLOYEE_MODE_BUTTON = "🧑🏻 Режим сотрудника"
OWNER_MODE_BUTTON = "👑 Вернуться в режим владельца"

funclist={0:("👨🏻‍💻 Смена", "📋 Задачи смены", "🚩 Доска проблем","🗓 Расписание", "🎮 Steam Tracker", "👤 Аккаунт", "🆘 Помощь"),
          1:("👨🏻‍💻 Смена", "📋 Задачи смены", "🚩 Доска проблем","🗓 Расписание", "🎮 Steam Tracker", "👤 Аккаунт", "🆘 Помощь"),
          2:("👨🏻‍💻 Смена", "📋 Задачи смены", "🚩 Доска проблем","🗓 Расписание", "🎮 Steam Tracker", "👤 Аккаунт", "🧑🏻‍💻 Админ панель", "🆘 Помощь"),
          3:("👨🏻‍💻 Смена", "📋 Задачи смены", "🚩 Доска проблем","🗓 Расписание", "🎮 Steam Tracker", "👤 Аккаунт", "💲 Финансы", "🧑🏻‍💻 Админ панель", "🆘 Помощь")} # с привилегиями
