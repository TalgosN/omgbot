...
admin_funclist = ['📢 Рассылки', '📣 Промо', '📊 KPI сотрудников', '📦 Расходники (Админ)', '⚙️ Обновить настройки', '🩺 Статус систем', '📦 Тест отчета по расходникам', '⬅️ Вернуться']
owner_admin_funclist = ['📢 Рассылки', '📣 Промо', '📊 KPI сотрудников', '📦 Расходники (Админ)', '⚙️ Обновить настройки', '🩺 Статус систем', '📊 Тест недельного отчета', '📦 Тест отчета по расходникам', '👥 Управление ролями', '⬅️ Вернуться']
