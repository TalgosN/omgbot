...
## Доска проблем
funclist_task=("➕ Добавить", "⭕ Текущие", "👀 Рассматриваемые", "🛠 Ремонт", "🤖 Улучшения бота", "✔ Выполненные", "🏠 Главное меню")
...
admin_funclist = ['📢 Рассылки', '✅ Задачи смены', '📝 Сценарии смен', '📊 KPI сотрудников', '⚙️ Система и тесты', '🏠 Главное меню']
owner_admin_funclist = ['📢 Рассылки', '✅ Задачи смены', '📝 Сценарии смен', '📊 KPI сотрудников', '👥 Сотрудники и роли', '⚙️ Система и тесты', '🏠 Главное меню']
admin_extra_funclist = ['⚙️ Обновить настройки', '🩺 Статус систем', '🎂 Тест поздравления', '⬅️ Назад в управление']
owner_admin_extra_funclist = ['⚙️ Обновить настройки', '🩺 Статус систем', '🎂 Тест поздравления', '📊 Тест недельного отчета', '⬅️ Назад в управление']

## Главное меню
OWNER_EMPLOYEE_MODE_BUTTON = "🧑🏻 Режим сотрудника"
OWNER_MODE_BUTTON = "👑 Вернуться в режим владельца"

funclist={0:("👨🏻‍💻 Смена", "🗓 Расписание", "🚩 Доска проблем", "🎮 Steam Tracker", "👤 Аккаунт", "🆘 Помощь"),
          1:("👨🏻‍💻 Смена", "🗓 Расписание", "🚩 Доска проблем", "🎮 Steam Tracker", "👤 Аккаунт", "🆘 Помощь"),
          2:("👨🏻‍💻 Смена", "🗓 Расписание", "🚩 Доска проблем", "🎮 Steam Tracker", "👤 Аккаунт", "🆘 Помощь", "🧑🏻‍💻 Управление"),
          3:("👨🏻‍💻 Смена", "🗓 Расписание", "🚩 Доска проблем", "🎮 Steam Tracker", "👤 Аккаунт", "🆘 Помощь", "💲 Финансы", "🧑🏻‍💻 Управление")} # с привилегиями
